...
public class PolicyImageViewController {
    ...
    public void setPolicy(Policy policy) {
        this.policy = policy;
        loadImages(policyImageVBox, this.policy.getPolicyImagePath());
        loadImages(claimImageVBox, this.policy.getClaimImagePath());
    ...
    private void loadImages(VBox vBox, List<String> list) {
        if (list != null) {
            try {
    ...
    private void addImageToVBox(String imagePath,VBox vBox) throws IOException {
